...
{
    /// <summary>
    /// Active version must be used with CustomTransformManager.cs written by Selcuk Aksoy (Selconag => Github).
    /// Custom inspector for Transform component. Using only DrawDefaultInspector would give different display.
    /// Script based on Unity wiki implementation : https://wiki.unity3d.com/index.php/TransformInspector WARNING : Website is no Longer Active!
    /// Original code has been taken from : https://gist.github.com/GhatSmith/66d2a5a60d278eaaf85a6b12d79fc633 
    ...
    {
        [SerializeField]
        public bool EnableAdvancedTransformUI;
        ...
        public void OnEnable()
        {
            ...
            EnableAdvancedTransformUI = CustomTransformManager.Instance.TransformAdvancedUIEnabled;
        ...
        //TO DO : Multiple object transform editing is constantly wrong
        //When editing multiple objects, changing one axis of any objects position changes every objects both 3 axises
        //This is not happening on both rotation and scale 
        /*
        public override void OnInspectorGUI()
        {
            Rect beginRect = GUILayoutUtility.GetRect(0, 0);
            ...
            if (CustomTransformManager.Instance.TransformAdvancedUIEnabled)
            {
                EditorGUIUtility.labelWidth = 60; // To allow float fields to expand when inspector width is increased
                ...
                EditorGUILayout.BeginHorizontal();
                if (GUILayout.Button("Toggle UI Elements", GUILayout.Width(120)))
                {
                    ToggleUIElements();
                }
                EditorGUILayout.EndHorizontal();
        ...
        */
        ...
        {
            CustomTransformManager.Instance.TransformAdvancedUIEnabled = !CustomTransformManager.Instance.TransformAdvancedUIEnabled;
        }
